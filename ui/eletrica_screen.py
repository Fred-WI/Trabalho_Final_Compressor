...
class EletricaScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        self.eletrica_indicators = {'ro.corrente_media': self.create_eletrica_indicator('electrical_services', 'Corrente Média'), 'ro.ativa_total': self.create_eletrica_indicator('bolt', 'Pot. Ativa'), 'ro.reativa_total': self.create_eletrica_indicator('bolt', 'Pot. Reativa'), 'ro.aparente_total': self.create_eletrica_indicator('bolt', 'Pot. Aparente'), 'ro.tensao_rs': self.create_eletrica_indicator('electrical_services', 'Tensão RS'), 'ro.fp_total': self.create_eletrica_indicator('power', 'FP Total'), 'ro.frequencia': self.create_eletrica_indicator('timeline', 'Frequência'), 'ro.torque': self.create_eletrica_indicator('settings', 'Torque'), 'ro.encoder': self.create_eletrica_indicator('speed', 'Rotação'), 'ro.temp_carc': self.create_eletrica_indicator('thermostat', 'Temp. Carcaça')}
